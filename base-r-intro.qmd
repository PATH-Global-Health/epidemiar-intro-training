...
Define your directory (folder) name (I'd suggest something like **R_training_workshop\_\[date\]**)\
...
dat = read_csv("data/district-cases-wide.csv") %>%
  pivot_longer(cols = Clinical:Tested_Passive_CHW, 
...
## **Cheat sheet of functions from this unit**
